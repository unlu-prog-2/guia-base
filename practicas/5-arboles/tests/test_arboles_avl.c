...
void test_operaciones_varias() {
    ...
    // Búsquedas
    assert(bool_true(avl_buscar(arbol, 2)));
    assert(bool_true(avl_buscar(arbol, 3)));
    assert(bool_true(avl_buscar(arbol, 1)));
    assert(bool_true(avl_buscar(arbol, 7)));
    ...
    assert(bool_false(avl_buscar(arbol, 2)));
    assert(bool_true(avl_buscar(arbol, 3)));
    assert(bool_true(avl_buscar(arbol, 1)));
    assert(bool_true(avl_buscar(arbol, 7)));
    ...
    assert(bool_true(avl_buscar(arbol, 3)));
    assert(bool_true(avl_buscar(arbol, 1)));
    assert(bool_false(avl_buscar(arbol, 7)));
    ...
    assert(bool_false(avl_buscar(arbol, 2)));
    assert(bool_false(avl_buscar(arbol, 3)));
    assert(bool_true(avl_buscar(arbol, 1)));
    assert(bool_false(avl_buscar(arbol, 7)));
    ...
    assert(bool_false(avl_buscar(arbol, 2)));
    assert(bool_false(avl_buscar(arbol, 3)));
    assert(bool_false(avl_buscar(arbol, 1)));
    assert(bool_false(avl_buscar(arbol, 7)));
}
